...
def run(**kwargs):
    ...
    for k, v in kwargs.items():
        setattr(opt, k, v)
    main(opt)
# python train.py --data mask_data.yaml --cfg mask_yolov5s.yaml --weights pretrained/yolov5s.pt --epoch 300 --batch-size
#  16  --device cuda

# data/target_data.yaml   models/target_yolov5s.yaml
# python train.py --data data/target_data.yaml --cfg models/target_yolov5s.yaml --weights pretrained/yolov5s.pt --epoch 300 --batch-size 16 --device GPU
# python train.py --data mask_data.yaml --cfg mask_yolov5s.yaml --weights pretrained/yolov5s.pt --epoch 100 --batch-size 16 4 --device cpu
