...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        # 初始化界面
        super().__init__()
        self.setWindowTitle('茶叶嫩芽检测系统（Tea bud detectionsystem）')
        self.resize(1200, 800)
        self.setWindowIcon(QIcon("images/UI/sly.jpg"))
        # 图片读取进程
    ...
    ***界面初始化***
    ...
    def initUI(self):
        ...
        img_detection_title = QLabel("单张茶叶图片识别功能")
        img_detection_title.setFont(font_title)
        mid_img_widget = QWidget()
        mid_img_layout = QHBoxLayout()
        self.left_img = QLabel()
        self.right_img = QLabel()
        self.left_img.setPixmap(QPixmap("images/UI/input.jpeg"))
        self.right_img.setPixmap(QPixmap("images/UI/output.jpeg"))
        ...
        up_img_button = QPushButton("上传单张图片")
        det_img_button = QPushButton("开始检测嫩芽")
        ...
        vid_title = QLabel("茶叶视频检测功能")
        vid_title.setFont(font_title)
        self.vid_img = QLabel()
        self.vid_img.setPixmap(QPixmap("images/UI/input.jpeg"))
        vid_title.setAlignment(Qt.AlignCenter)
        self.vid_img.setAlignment(Qt.AlignCenter)
        self.webcam_detection_btn = QPushButton("摄像头实时监测茶叶嫩芽")
        self.mp4_detection_btn = QPushButton("视频文件检测茶叶嫩芽")
        self.vid_stop_btn = QPushButton("停止检测茶叶嫩芽")
        ...
        self.setTabIcon(0, QIcon('images/UI/sly.jpg'))
        self.setTabIcon(1, QIcon('images/UI/sly.jpg'))
