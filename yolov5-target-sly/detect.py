...
def run(weights=ROOT / 'yolov5s.pt',  # model.pt path(s)
        ...
        # save_txt=ROOT / 'runs/detect/loc.txt',
        ...
        for i, det in enumerate(pred):  # per image
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    c1, c2, c3, c4, c5, c6 = annotator.box_label(xyxy, label, color=colors(c, True))
                    # print(c1, c2, c3, c4, c5, c6, label_no_value)
...
# python detect.py --weights runs/train/exp5/weights/best.pt --source  data/images/hole/1.jpg
